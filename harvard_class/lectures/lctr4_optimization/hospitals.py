...
# Class That Represents the State Space (the entire landscape or map)
class Space():
    ...
    def hill_climb(self, maximum=None, image_prefix=None, log=False):
        ...
        while maximum is None or count < maximum:
            ...
            # None of the neighbors are better than the current state, return current state
            if best_neighbor_cost >= self.get_cost(self.hospitals):
                return self.hospitals

            # Move to a highest-valued neighbor as their cost is less then the current state
            else:
                if log:
